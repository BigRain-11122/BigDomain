...
- [ ] P-47-3 UGC+msgSecCheck 管道设计（前置闸合规面）——规格半件 [done 2026-09-24]（docs/spec/ugc-pipeline-spec.md·AC-U1~U12+AC-UP1~UP5 判据预注册先行+合规四件套齐）；骨架半件=P-47-3b 拆细（backlog 顶行）；来源=ledger P-47
